...
% *******************************************************************
    ...
    P2_11 = same_side([P2(1,1:2), 0], [P1(1,1:2), 0], [P1(2,1:2), 0], [P1(3,1:2), 0]);
    P2_12 = same_side([P2(1,1:2), 0], [P1(2,1:2), 0], [P1(1,1:2), 0], [P1(3,1:2), 0]);
    P2_13 = same_side([P2(1,1:2), 0], [P1(3,1:2), 0], [P1(1,1:2), 0], [P1(2,1:2), 0]);
    ...
    P2_21 = same_side([P2(2,1:2), 0], [P1(1,1:2), 0], [P1(2,1:2), 0], [P1(3,1:2), 0]);
    P2_22 = same_side([P2(2,1:2), 0], [P1(2,1:2), 0], [P1(1,1:2), 0], [P1(3,1:2), 0]);
    P2_23 = same_side([P2(2,1:2), 0], [P1(3,1:2), 0], [P1(1,1:2), 0], [P1(2,1:2), 0]);
    ...
    P2_31 = same_side([P2(3,1:2), 0], [P1(1,1:2), 0], [P1(2,1:2), 0], [P1(3,1:2), 0]);
    P2_32 = same_side([P2(3,1:2), 0], [P1(2,1:2), 0], [P1(1,1:2), 0], [P1(3,1:2), 0]);
    P2_33 = same_side([P2(3,1:2), 0], [P1(3,1:2), 0], [P1(1,1:2), 0], [P1(2,1:2), 0]);  
