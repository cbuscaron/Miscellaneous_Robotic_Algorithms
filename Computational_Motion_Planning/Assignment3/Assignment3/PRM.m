...
for i = 2:nsamples
    ...
    %Use the array distances generated by Dist function to determine the indices of the k nearest
    %neighbors. (Hint: you may find the sort function useful here.)
    %2. For each of those neighbors, it should determine whether or not it can forge a path between
    % those two locations using the LocalPlanner function.
